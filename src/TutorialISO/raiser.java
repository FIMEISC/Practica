 ...
 * @author bravo
 */
public class raiser extends javax.swing.JFrame {

    /**
     * Creates new form raiser
     */
    public raiser() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTextArea1.setText("Es el sistema de ficheros de ultima generacion\npara Linux organiza los ficheros de tal modo \nque se agilizan mucho las operaciones con \nestos. \n\nEl problema de ser tan actual es que muchas\nherramientas no lo soportan.");
        jScrollPane1.setViewportView(jTextArea1);

        jLabel1.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel1.setText("¿Que es RaiserFS?");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(raiser.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
